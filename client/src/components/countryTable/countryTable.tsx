...
class CountryTable extends React.Component<CountryTableProps, CountryTableState> {
    ...
    componentDidMount = async() => {
        await client.query({query: GET_COUNTRY_ALL, variables:{ date: this.props.date}}).then((res: any)=> {
            this.setState({allCountries: res.data.getCountryAll, countries: res.data.getCountryAll})
        })
    }
    ...
    render() { 
        return ( <div className='countryTableHolder'>
            <div className='countryTable'>
                <div className='countryPanelTitle'><b>
                    <input type="text" name="countryName" className='countryname' value={this.state.countryName} onChange={this.changeHandler} placeholder="Country Name" ></input>
